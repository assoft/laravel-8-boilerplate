<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @canany(["role_access", "permission_access"])
                    <x-jet-nav-link :href="route('admin.roles-and-permissions')"
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @canany(["role_access", "permission_access"])
            <x-jet-responsive-nav-link :href="route('admin.roles-and-permissions')"
                :active="request()->routeIs('admin.roles-and-permissions')">
                {{ __('Roles and Permissions') }}
            </x-jet-responsive-nav-link>
            @endcanany
